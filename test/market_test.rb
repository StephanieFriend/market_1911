...
class MarketTest < Minitest::Test
  ...
  def test_it_can_return_vendors_that_sell_by_item
    market = Market.new("South Pearl Street Farmers Market")
    vendor1 = Vendor.new("Rocky Mountain Fresh")
    item1 = Item.new({name: 'Peach', price: "$0.75"})
    item2 = Item.new({name: 'Tomato', price: '$0.50'})
  ...
  def test_it_can_return_sorted_item_list_alphabetically
    market = Market.new("South Pearl Street Farmers Market")
    vendor1 = Vendor.new("Rocky Mountain Fresh")
    item1 = Item.new({name: 'Peach', price: "$0.75"})
    item2 = Item.new({name: 'Tomato', price: '$0.50'})
    ...
    assert_equal ["Banana Nice Cream", "Peach-Raspberry Nice Cream", "Peach", "Tomato"], market.sorted_item_list
  end
  ...
  def test_the_market_can_sell_items_and_will_deplete_stock
    market = Market.new("South Pearl Street Farmers Market")
    vendor1 = Vendor.new("Rocky Mountain Fresh")
    item1 = Item.new({name: 'Peach', price: "$0.75"})
    item2 = Item.new({name: 'Tomato', price: '$0.50'})
